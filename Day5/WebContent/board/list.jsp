...
SimpleDateFormat sf = new SimpleDateFormat("yyyy-MM-dd"); //형식을 바꿔주는 함수 SimpleDateFormat();
	...
	try{
		...
		/*
		sql = "select * tb_board order by b_idx desc limit 0,10; -- 0부터 10개";
		sql = "select * tb_board order by b_idx desc limit 10,10; -- 10부터 10개";
		sql = "select * tb_board order by b_idx desc limit 20,10; -- 20부터 10개";
		pstmt = conn.prepareStatement(sql);
		*/
		pstmt = conn.prepareStatement(sql);
...
%>
			...
			<img width="20" height="15" src="plusicon.png">
<% 			
		}
%>
